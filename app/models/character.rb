...
class Character < ActiveRecord::Base
	...
	def can_put_on?(char_item)
		...
		return false if char_item.item.item_type.wear_limit and char_item.find_same_type_eq.count >= char_item.item.item_type.wear_limit
		return true
	end
